...
public class JFFInvertSelection extends AbstractAction {

	private JFFTable Table;
	
	public JFFInvertSelection(JFFTable t, JFFBundledItems items){
		super(items.S.invertSelection(),new ImageIcon("img/invertselection.png"));
		
		Table=t;
		
		
		putValue(SHORT_DESCRIPTION, items.S.invertSelectionDescription());  // Will appear as tooltip text.
