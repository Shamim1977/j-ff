...
public class JFFSelectAll extends AbstractAction {

	private JFFTable Table;
	
	public JFFSelectAll(JFFTable t, JFFBundledItems items){
		super(items.S.selectAll(),new ImageIcon("img/selectall.png"));
		
		Table=t;
		
		
		putValue(SHORT_DESCRIPTION, items.S.selectAllDescription());  // Will appear as tooltip text.
